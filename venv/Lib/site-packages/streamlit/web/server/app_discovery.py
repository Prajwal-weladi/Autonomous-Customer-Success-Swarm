...
_PREFERRED_APP_NAMES: Final[tuple[str, ...]] = ("app", "frontend")
...
def discover_asgi_app(
    ...
    Preferred names checked first: "app", "frontend".
    ...
    app_name
        ...
        ("app", "frontend"), then falls back to any
        discovered ASGI app.
    ...
    Examples
    --------
    >>> result = discover_asgi_app(Path("frontend.py"))
